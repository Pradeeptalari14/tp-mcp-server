# 🔧 Troubleshooting Guide — MCP Server Builder Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-mcp-server/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/mcp-server/)
